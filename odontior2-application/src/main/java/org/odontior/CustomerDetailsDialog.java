...
public class CustomerDetailsDialog extends DataAccessDialog {
	public CustomerDetailsDialog(Object callContext) {
		...
		DataAccessPanel dataAccessPanel = Factory.addDataAccessPanel(m_contentPanel, new CustomerPanel(true));
		...
		setBounds(2, 2, 606, 514);
		m_isViewer = true;
	}

	@Override
	protected void setEntityName() {
		m_entityName = appLang("CustomerDetails");
	}
}
