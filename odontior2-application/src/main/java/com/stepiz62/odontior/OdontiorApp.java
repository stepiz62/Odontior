...
import com.stepiz62.odontior.common.OdontiorDbManager;
import com.stepiz62.odontior.common.OdontiorDbManager.Subcases;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					app = new OdontiorApp();
					app.init("Odontior 2.0", "2.0.8", null, null);
					} catch (Exception e) {
					e.printStackTrace();
