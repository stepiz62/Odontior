...
public class PatCustDetails extends DataDetailsActivity {
    ...
    void openCustomerActivity(String id) {
        openDetails(id, CustomerDetails.class, "org.odontior.CustomerDialog", id == null ? R.id.relatedcustomer : 0);
    }
    ...
    private void doTheSetting(boolean isThePatient) {
        if (isThePatient) {
            ...
            accessorCoordinates.jotyDialogClassName = "org.odontior.CustomerDialog";
