...
public class PatCustList extends DataResultActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_relatedpersons_list);
        setTitle(m_app.m_common.appLang("RelatedCustomers") + " - " + m_resultController.m_extras.getString("patientname"));
    }
    ...
    public boolean checkRowForOpeningDetail(JotyResourceCursorAdapter adapter, Bundle m_extras) {
        ...
        m_extras.putString("relatedCustomer",  cursor.getString("lastname") + " " + cursor.getString("firstname"));
        return super.checkRowForOpeningDetail(adapter, m_extras);
    }
}
