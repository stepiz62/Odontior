...
public class PatientDetails extends DataDetailsActivity {
    ...
    private void relatedCustomers() {
        ...
        resultController.m_accessorCoordinates.jotyDialogClassName = "org.odontior.PatientDialog";
    ...
    private void relatedImages() {
        ...
        resultController.instantiateOwnData();
        resultController.m_accessorCoordinates.jotyDialogClassName = "org.odontior.ImageDialog";
